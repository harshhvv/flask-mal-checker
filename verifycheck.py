...
def feature_extraction(data):
    ...
    features["SizeOfInitializedData"] = data["Image Optional Header"][
        "SizeOfInitializedData"
    ]
    features["SizeOfUninitializedData"] = data["Image Optional Header"][
        "SizeOfUninitializedData"
    ]
    features["AddressOfEntryPoint"] = data["Image Optional Header"][
        "AddressOfEntryPoint"
    ]
    ...
    features["NumberOfRvaAndSizes"] = data["Image Optional Header"][
        "NumberOfRvaAndSizes"
    ]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Detect malicious file from manalyzer infos"
    )
